...
public extension Gql {
  class ChatRegisterMutation: GraphQLMutation {
    public static let operationName: String = "ChatRegister"
    public static let operationDocument: Apollo.OperationDocument = .init(
      definition: .init(
        #"mutation ChatRegister($input: ChatRegisterInput!) { chatRegister(input: $input) { __typename token user { __typename ...FUser blocks blocked_by role } } }"#,
        fragments: [FUser.self, FDevice.self]
      ))

    public var input: ChatRegisterInput

    public init(input: ChatRegisterInput) {
      self.input = input
    }
    ...
    public struct Data: Gql.SelectionSet {
      ...
      public static var __selections: [Apollo.Selection] { [
        .field("chatRegister", ChatRegister?.self, arguments: ["input": .variable("input")]),
      ] }

      public var chatRegister: ChatRegister? { __data["chatRegister"] }

      /// ChatRegister
      ///
      /// Parent Type: `Auth`
      public struct ChatRegister: Gql.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }

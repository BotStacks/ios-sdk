  ...
  class CreateGroupMutation: GraphQLMutation {
    ...
    public struct Data: Gql.SelectionSet {
      ...
      public static var __selections: [Apollo.Selection] { [
        .field("createGroup", CreateGroup?.self, arguments: ["input": .variable("input")]),
      ] }

      /// Create a new group Chat
      public var createGroup: CreateGroup? { __data["createGroup"] }

      /// CreateGroup
      ///
      /// Parent Type: `Chat`
      public struct CreateGroup: Gql.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }
        ...
        public struct Member: Gql.SelectionSet {
          ...
          public struct User: Gql.SelectionSet {
            ...
            /// CreateGroup.Member.User.Device
            ///
            /// Parent Type: `Device`
        ...
        public struct Last_message: Gql.SelectionSet {
          ...
          public struct User: Gql.SelectionSet {
            ...
            /// CreateGroup.Last_message.User.Device
            ///
            /// Parent Type: `Device`
            public struct Device: Gql.SelectionSet {
              public let __data: DataDict

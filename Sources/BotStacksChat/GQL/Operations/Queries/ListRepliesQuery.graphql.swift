...
public extension Gql {
  class ListRepliesQuery: GraphQLQuery {
    public static let operationName: String = "ListReplies"
    public static let operationDocument: Apollo.OperationDocument = .init(
      definition: .init(
        #"query ListReplies($message: ID!, $skip: Int, $limit: Int) { replies(message: $message, offset: $skip, count: $limit) { __typename ...FMessage } }"#,
    ...
    public struct Data: Gql.SelectionSet {
      ...
      public static var __selections: [Apollo.Selection] { [
        .field("replies", [Reply].self, arguments: [
          "message": .variable("message"),
          "offset": .variable("skip"),
          "count": .variable("limit")
        ]),
      ] }
      ...
      ///
      /// Parent Type: `Message`
      public struct Reply: Gql.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }

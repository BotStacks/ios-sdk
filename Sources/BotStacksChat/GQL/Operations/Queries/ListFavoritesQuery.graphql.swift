...
public extension Gql {
  class ListFavoritesQuery: GraphQLQuery {
    public static let operationName: String = "ListFavorites"
    public static let operationDocument: Apollo.OperationDocument = .init(
      definition: .init(
        #"query ListFavorites($count: Int, $offset: Int) { favorites(count: $count, offset: $offset) { __typename ...FMessage } }"#,
    ...
    public struct Data: Gql.SelectionSet {
      ...
      public static var __selections: [Apollo.Selection] { [
        .field("favorites", [Favorite].self, arguments: [
      ...
      public var favorites: [Favorite] { __data["favorites"] }

      /// Favorite
      ///
      /// Parent Type: `Message`
      public struct Favorite: Gql.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }

...
public struct AZVideoPlayer: UIViewControllerRepresentable {
  ...
  public init(
    ...
    self.willBeginFullScreenPresentationWithAnimationCoordinator =
      willBeginFullScreenPresentationWithAnimationCoordinator
    self.willEndFullScreenPresentationWithAnimationCoordinator =
  ...
  public final class Coordinator: NSObject, AVPlayerViewControllerDelegate {
    ...
    public func playerViewController(
      ...
      parent.willBeginFullScreenPresentationWithAnimationCoordinator?(
        playerViewController, coordinator)
    }
    ...
    public func playerViewController(
      ...
      parent.willEndFullScreenPresentationWithAnimationCoordinator?(
        playerViewController, coordinator)
    }
  }

  public static func continuePlayingIfPlaying(
    _ player: AVPlayer?,

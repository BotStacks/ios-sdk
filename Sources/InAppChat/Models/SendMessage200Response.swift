...
public struct SendMessage200Response: Codable, JSONEncodable, Hashable {
    ...
    public enum ReturnCode: String, Codable, CaseIterable {
    ...
    public init(msgUniqueId: String, message: String? = nil, msgType: String? = nil, contact: Contact? = nil, location: Location? = nil, media: Media? = nil, gify: String? = nil, sendereRTCUserId: String, createdAt: String, replyThreadFeatureData: Reply? = nil, forwardChatFeatureData: Forward? = nil, reactions: [Reaction]? = nil, isEdited: Bool? = nil, isStarred: Bool? = nil, follow: Bool? = nil, chatReportId: String? = nil, chatReportStatus: ChatReportStatus? = nil, mentions: [Mention]? = nil, customData: [String: AnyCodable]? = nil, deleteScheduleAt: String? = nil, replyMsgCount: Int? = nil, threadId: String, replies: [APIMessage]? = nil, encryptedChatList: [EncryptedMessage]? = nil, senderKeyDetails: SenderKeyDetails? = nil, returnCode: ReturnCode, retryRequired: Bool, keyList: [ChatStatusKeyListInner]) {

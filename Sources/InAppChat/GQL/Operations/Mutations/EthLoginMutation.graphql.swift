...
public extension Gql {
  class EthLoginMutation: GraphQLMutation {
    ...
    public var input: EthLoginInput

    public init(input: EthLoginInput) {
      self.input = input
    }
    ...
    public struct Data: Gql.SelectionSet {
      ...
      public static var __selections: [Apollo.Selection] { [
        .field("ethLogin", EthLogin?.self, arguments: ["input": .variable("input")]),
      ] }

      /// Login as an NFT authenticated user
      public var ethLogin: EthLogin? { __data["ethLogin"] }

      /// EthLogin
      ///
      /// Parent Type: `Auth`
      public struct EthLogin: Gql.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }

  ...
  class UpdateMessageMutation: GraphQLMutation {
    ...
    public struct Data: Gql.SelectionSet {
      ...
      public static var __selections: [Apollo.Selection] { [
        .field("updateMessage", UpdateMessage.self, arguments: ["input": .variable("input")]),
      ] }

      /// Update the contents of a Message
      public var updateMessage: UpdateMessage { __data["updateMessage"] }

      /// UpdateMessage
      ///
      /// Parent Type: `Message`
      public struct UpdateMessage: Gql.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }

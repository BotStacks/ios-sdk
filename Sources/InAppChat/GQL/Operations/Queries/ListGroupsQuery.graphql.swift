...
public extension Gql {
  class ListGroupsQuery: GraphQLQuery {
    public static let operationName: String = "ListGroups"
    public static let operationDocument: Apollo.OperationDocument = .init(
      definition: .init(
        #"query ListGroups($count: Int, $offset: Int) { groups(count: $count, offset: $offset) { __typename ...FChat } }"#,
    ...
    public struct Data: Gql.SelectionSet {
      ...
      public static var __selections: [Apollo.Selection] { [
        .field("groups", [Group].self, arguments: [
      ...
      ///
      /// Parent Type: `Chat`
      public struct Group: Gql.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }
        ...
        public struct Last_message: Gql.SelectionSet {
          ...
          public struct User: Gql.SelectionSet {
            ...
            /// Group.Last_message.User.Device
            ///
            /// Parent Type: `Device`
            public struct Device: Gql.SelectionSet {
              public let __data: DataDict

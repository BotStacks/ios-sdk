...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RollbarCommon/RollbarCommon.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/RollbarNotifier/RollbarNotifier.framework"
